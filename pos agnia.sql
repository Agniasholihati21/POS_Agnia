...
CREATE DATABASE IF NOT EXISTS `pos_agnia` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `pos_agnia`;
...
-- Dumping data for table pos_agnia.item_penjualan: ~23 rows (approximately)
INSERT INTO `item_penjualan` (`id`, `penjualan_id`, `produk_id`, `kuantitas`, `harga_satuan`, `subtotal`, `created_at`, `updated_at`) VALUES
	...
	(35, 34, 9, 1, 600000, 600000, '2026-09-16 05:40:50', '2026-09-16 05:40:50'),
	(36, 35, 4, 1, 500000, 500000, '2026-09-16 06:02:54', '2026-09-16 06:02:54');
...
-- Dumping data for table pos_agnia.migrations: ~7 rows (approximately)
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
	...
	(8, '2026_09_16_122234_add_payment_fields_to_penjualans_table', 2);
...
-- Dumping data for table pos_agnia.penjualan: ~17 rows (approximately)
INSERT INTO `penjualan` (`id`, `user_id`, `total_pembayaran`, `uang_dibayar`, `kembalian`, `metode_pembayaran`, `status`, `created_at`, `updated_at`) VALUES
	(1, 1, 150000, 0.00, 0.00, 'CASH', 'COMPLETED', '2026-08-04 07:15:15', '2026-08-04 07:15:34'),
	(3, 1, 30000, 0.00, 0.00, 'QRIS', 'COMPLETED', '2026-08-05 01:50:32', '2026-08-05 02:04:26'),
	(4, 1, 30000, 0.00, 0.00, 'CASH', 'COMPLETED', '2026-08-05 02:06:17', '2026-08-05 02:10:14'),
	(5, 2, 30000, 0.00, 0.00, 'QRIS', 'COMPLETED', '2026-08-05 02:12:25', '2026-08-05 02:12:42'),
	(6, 2, 30000, 0.00, 0.00, 'QRIS', 'COMPLETED', '2026-08-05 02:13:10', '2026-08-05 03:51:30'),
	(7, 1, 240000, 0.00, 0.00, 'CASH', 'COMPLETED', '2026-08-05 03:59:34', '2026-08-05 04:00:04'),
	(10, 1, 260000, 0.00, 0.00, 'QRIS', 'COMPLETED', '2026-08-10 04:37:39', '2026-08-10 05:06:02'),
	(11, 2, 240000, 0.00, 0.00, 'CASH', 'COMPLETED', '2026-08-10 05:07:55', '2026-08-10 05:08:22'),
	(12, 1, 450000, 0.00, 0.00, 'CASH', 'COMPLETED', '2026-08-10 06:45:53', '2026-08-10 06:51:48'),
	(15, 1, 1000000, 0.00, 0.00, 'CASH', 'COMPLETED', '2026-08-11 02:24:33', '2026-08-11 02:24:48'),
	(16, 2, 150000, 0.00, 0.00, 'QRIS', 'COMPLETED', '2026-08-11 02:26:12', '2026-08-11 02:26:27'),
	(18, 1, 20000, 0.00, 0.00, 'CASH', 'COMPLETED', '2026-08-12 06:34:28', '2026-08-12 06:35:57'),
	(20, 1, 120000, 0.00, 0.00, 'QRIS', 'COMPLETED', '2026-08-18 06:13:34', '2026-08-18 06:14:32'),
	(29, 1, 180000, 0.00, 0.00, 'CASH', 'COMPLETED', '2026-08-28 02:57:23', '2026-08-28 02:57:46'),
	(30, 1, 450000, 0.00, 0.00, 'QRIS', 'COMPLETED', '2026-08-28 02:58:51', '2026-08-28 02:59:38'),
	(32, 1, 1000000, 0.00, 0.00, 'QRIS', 'COMPLETED', '2026-09-01 03:54:54', '2026-09-02 05:50:29'),
	(33, 1, 1100000, 0.00, 0.00, 'CASH', 'COMPLETED', '2026-09-02 05:50:57', '2026-09-02 05:51:16'),
	(34, 1, 600000, 900000.00, 300000.00, 'CASH', 'COMPLETED', '2026-09-16 05:40:39', '2026-09-16 05:41:42'),
	(35, 1, 500000, 500000.00, 0.00, 'QRIS', 'COMPLETED', '2026-09-16 05:41:57', '2026-09-16 06:03:03');
...
INSERT INTO `produk` (`id`, `user_id`, `foto`, `nama`, `harga_beli`, `harga_jual`, `stok`, `created_at`, `updated_at`) VALUES
	...
	(4, 1, 'products/3B7rP88dWdH3t42D76RtK8RQrviQA1WZx8MKusBi.jpg', 'Sweet Purple', 0, 500000, 78, '2026-08-05 03:55:26', '2026-09-16 06:02:54'),
	...
	(9, 1, 'products/GjWe9drzTwYT1K6ZBP37Iq7grLfMtRDoyYSg3k9I.jpg', 'Purple Dream Bouquet', 0, 600000, 49, '2026-08-05 03:58:13', '2026-09-16 05:40:50'),
...
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('zKadLF0iXlACmf8c5fUxUOo3qdbIbWC4z0zmvk9n', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '', 1789539000);
...
INSERT INTO `users` (`id`, `role_id`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 1, 'Dr. Shanelle Cormier V', 'awisozk@example.com', '2026-07-21 23:25:36', '$2y$12$sq0xjT.S3x5u..t6awJob.MwnzeQ0gggmDqTIxX3Vrzdw5vghnk9a', 'HUftXnfB6an3f1v6VTDj6KEo5jY69h9WFNIs9gtvQx51sgky8k9y6fUxdQEp', '2026-07-21 23:25:36', '2026-07-21 23:25:36'),
	(2, 2, 'Yasmin Schmeler', 'watsica.kyla@example.org', '2026-07-21 23:25:36', '$2y$12$sq0xjT.S3x5u..t6awJob.MwnzeQ0gggmDqTIxX3Vrzdw5vghnk9a', '7366A8HL6bKnMRz93eym9yapncMnOFvDlSegCUYnRt8dDXQ4p4W0NOzXerl2', '2026-07-21 23:25:36', '2026-07-21 23:25:36'),
