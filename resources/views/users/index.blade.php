...
<div class="container my-4">
  <div class="page-header d-flex justify-content-between align-items-center flex-wrap gap-3">
    ...
    <div class="d-none d-md-block">
      <i class="bi bi-people display-4 text-white" style="opacity: 0.3;"></i>
    </div>
  </div>
          ...
          <tr>
            ...
            <td class="text-center">
              @if(strtolower($user->role->name) == 'admin')
                <span class="badge-role-admin"><i class="bi bi-shield-lock-fill me-1"></i> {{ $user->role->name }}</span>
              @elseif(strtolower($user->role->name) == 'user' || strtolower($user->role->name) == 'kasir')
                <span class="badge-role-user"><i class="bi bi-person-badge me-1"></i> {{ $user->role->name }}</span>
              @else
                <span class="badge-role-default">{{ $user->role->name }}</span>
              @endif
            </td>
            <td class="text-center">
